...
-->
Neuro-iX is directed by Sylvain Bouix, [Canada Research Chair](https://www.chairs-chaires.gc.ca/){target="_blank"} in Neuroinformatics for Multimodal Data at [École de technology supérieure](https://www.etsmtl.ca/){target="_blank"}. This brand new lab revolves around developing robust softwares to analyse brain imaging and behavioral data for the study of mental disorders in particular [schizophrenia](https://www.ampscz.org/){target="_blank"}, brain injury and [chronic traumatic encephalopathy](https://diagnosecte.com/){target="_blank"}. 
